...
try {
    // Fetch appointments with service name, status, and vehicle details
    $stmt = $pdo->prepare("
        SELECT 
            SO.OfferingName,
        ...
        LEFT JOIN ScheduleEmployee SE ON S.CustomerUserID = SE.CustomerUserID 
                    ...
                    <div class='modal-body'>
                        <div class='row'>
                            <div class='col-md-6'>
                                ...
                                <p><strong>Assigned Employee:</strong> " . ($appt['EmployeeName'] ?? 'Not assigned') . "</p>
                            </div>
                            <div class='col-md-6'>
